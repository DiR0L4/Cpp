...
QT_MOC_LITERAL(7, 19), // "setSectorHeightSlot"
QT_MOC_LITERAL(27, 0), // ""
QT_MOC_LITERAL(28, 3) // "str"

    },
    "Figure\0setSectorHeightSlot\0\0str"
};
...
void Figure::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->setSectorHeightSlot((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject Figure::staticMetaObject = { {
    QMetaObject::SuperData::link<Sector::staticMetaObject>(),
...
void *Figure::qt_metacast(const char *_clname)
{
    ...
    return Sector::qt_metacast(_clname);
}

int Figure::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = Sector::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
